...
return null},Vc=!1;if(F.querySelectorAll)try{var Wc=F.querySelectorAll(":root");Wc&&1==Wc.length&&Wc[0]==F.documentElement&&(Vc=!0)}catch(a){}var Sc=Vc;var jd={},kd=null,ld=Math.random();jd.s="GTM-MVMGKF";jd.Ob="640";jd.Ld="";var md={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},od="www.googletagmanager.com/gtm.js";
...
return!a}function Yj(){var a=Xj();try{sj(E["gtmDataLayer"],jd.s)}catch(b){}return a}
var ak=function(){var a=hc("gtmDataLayer",[]),b=hc("google_tag_manager",{});b=b["gtmDataLayer"]=b["gtmDataLayer"]||{};Kg(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});yj(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var d;if(0<kd.SANDBOXED_JS_SEMAPHORE){d=[];for(var e=0;e<arguments.length;e++)d[e]=new Qj(arguments[e])}else d=[].slice.call(arguments,0);var f=c.apply(a,d);Rj.push.apply(Rj,d);if(300<
...
b);return E[a]},Sk=function(a,b,c){return ue(a,b,void 0===c?!0:!!c)},Tk=function(a,b){if(dg()){b&&G(b)}else lc(a,b)},Uk=function(a){return!!ik(a,"init",!1)},Vk=function(a){gk(a,"init",!0)},Wk=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":pd;c+="?id="+encodeURIComponent(a)+"&l=gtmDataLayer";K(fg("https://","http://",c))},Xk=function(a,b){var c=a[b];return c};
...
function un(a,b){}var W={a:{}};W.a.ctv=["google"],function(){(function(a){W.__ctv=a;W.__ctv.b="ctv";W.__ctv.g=!0;W.__ctv.priorityOverride=0})(function(){return"5"})}();
